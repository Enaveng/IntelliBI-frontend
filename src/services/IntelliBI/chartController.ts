...
/** asyncGenChartByAi POST /api/chart/gen/async */
export async function asyncGenChartByAiUsingPOST(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.asyncGenChartByAiUsingPOSTParams,
  body: {},
  file?: File,
  options?: { [key: string]: any },
) {
...
/** asyncGenChartByAiMq POST /api/chart/gen/async/mq */
export async function asyncGenChartByAiMqUsingPOST(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.asyncGenChartByAiMqUsingPOSTParams,
  body: {},
  file?: File,
  options?: { [key: string]: any },
) {
...
export async function getChartByIdUsingGET(
  ...
  return request<API.BaseResponseChartDataVo_>('/api/chart/get', {
    method: 'GET',
    params: {
      ...params,
    },
